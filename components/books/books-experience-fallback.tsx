  ...
  return (
    <section className="relative px-6 py-32 md:px-8">
          ...
          return (
            <article key={id} className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
              ...
              <div className="text-center md:text-left">
                {book.tagline && <p className="label mb-3 text-gold">{book.tagline}</p>}
      ...
      <div className="mx-auto mt-28 flex max-w-xl flex-col items-center text-center">
        <Image src="/inger-alex-moore-logo.png" alt="Inger & Alex Moore" width={220} height={68} className="mb-6 h-auto w-56 object-contain opacity-95" />
